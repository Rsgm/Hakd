...
public final class Connection {
	...
	if (siblingConnection != null
		&& !siblingConnection.getRoute().isEmpty()) {
	    route.addAll(siblingConnection.getRoute());
	    Lists.reverse(route);
	    speed = siblingConnection.getSpeed();
	} else {
	    Pathfinder p = new Pathfinder((ArrayList<Node>) host.getNetwork()
		    .getInternet().getRouterNodes());
	...
	case BACKBONE:
	    cylinder = modelBuilder.createCylinder(1.2f, distance, 1.2f, 5,
	...
	case ISP:
	    ...
	    break;
	default:
	    cylinder = modelBuilder.createCylinder(0.3f, distance, 0.3f, 5,
