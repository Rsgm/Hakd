...
public class Server implements ConnectableDevice {

	// stats
	private final Network			network;
	private final int				networkId;							// which network a server belongs to
	private final int				serverId;							// server id starts at 0 in the gui as well
