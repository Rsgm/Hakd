...
public interface Network {
	...
	PLAYER(), BUSINESS(), TEST(), ISP(), NPC(), BACKBONE(), EDUCATION(), BANK(), MILITARY(), GOVERNMENT(), RESEARCH();
	NetworkType() {
	}
    }
	...
	BUSINESS(1, 56), SA(57, 62), NA(63, 76), EUROPE(77, 91), ASIA(92, 114), AFRICA(
		115, 126), PRIVATE(128, 172), EDUCATION(173, 182), GOVERNMENT(
		214, 220), MILITARY(220, 255), none(1, 255);
